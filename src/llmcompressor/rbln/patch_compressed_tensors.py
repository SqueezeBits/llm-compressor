...
compressed_tensors.quantization.utils.helpers.calculate_qparams = calculate_qparams_patched
compressed_tensors.quantization.utils.calculate_qparams = calculate_qparams_patched
